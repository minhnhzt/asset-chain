...
export function SolarWindsAssets({ 
  ...
  // Use provided assets or fall back to default mock data
  const assetsData = propAssets || assets;
    ...
    <div className="p-6 space-y-6 bg-gray-50 min-h-screen">
      ...
      <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
        <Card className="p-4 bg-white border-gray-200">
          <div className="text-2xl text-gray-900 mb-1">{assetsData.length}</div>
          <div className="text-sm text-gray-600">Total Assets</div>
        </Card>
        <Card className="p-4 bg-white border-gray-200">
          <div className="text-2xl text-green-600 mb-1">
            {assetsData.filter((a) => a.status === 'available').length}
          </div>
          <div className="text-sm text-gray-600">Available</div>
        </Card>
        <Card className="p-4 bg-white border-gray-200">
          <div className="text-2xl text-orange-600 mb-1">
            {assetsData.filter((a) => a.status === 'checked-out').length}
          </div>
          <div className="text-sm text-gray-600">Checked Out</div>
        </Card>
        <Card className="p-4 bg-white border-gray-200">
          <div className="text-2xl text-yellow-600 mb-1">
            {assetsData.filter((a) => a.status === 'maintenance').length}
          </div>
